...
const reviewsUr = [
  {
    quote:
      "خان کی اورا بہت شاندار ہے — میں نے عید کی دعوت پر پہنی اور رات بھر لاڈ ملتا رہا۔",
    name: "حمزہ ر ۔",
    city: "لاہور",
  },
  {
    quote:
      "حبیبی جلد پر مخمل جیسی خوشبو ہے — میٹھی لیکن بہت نفیس، روزانہ پہن سکتا ہوں۔",
    name: "ثنا ک ۔",
    city: "اسلام آباد",
  },
  {
    quote:
      "اسپورٹی جمن اور دفتر دونوں میں چلتی ہے — لیموں کی تازگی اور ویٹیور کا اختتام واقعی صاف۔",
    name: "عمر و ۔",
    city: "کراچی",
  },
];
